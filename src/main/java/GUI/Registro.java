...
public class Registro extends javax.swing.JFrame {
    ...
    private void btnGotToLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGotToLoginActionPerformed
        Login login = new Login();
        login.setVisible(true);

        dispose();
    }//GEN-LAST:event_btnGotToLoginActionPerformed
